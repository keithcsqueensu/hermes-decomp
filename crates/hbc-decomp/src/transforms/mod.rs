...
pub use inline::{
    ...
    eliminate_immutable_aliases, inline_expressions, inline_named_variables, insert_declarations,
...
pub use var_naming::{infer_variable_names, inherit_ancestor_closure_names, rename_closure_variables, rename_closure_variables_cross_function, rename_closures_from_definitions};
