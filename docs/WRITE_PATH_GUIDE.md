...
- **The `options` bitfield, and the CJS table's two meanings** → R27, and P5 of the same
  document. Hours of work, and the only item in that plan that fixes an output which is
