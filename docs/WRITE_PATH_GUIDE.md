...
- **Debug info: a guard, then a reader, then relocation** → R24 and
  `UNMODELED_REGIONS_PLAN.md`. P0 (the guard) is a day's work and closes a live hole; the
